...
-- AddForeignKey
ALTER TABLE "property" ADD CONSTRAINT "property_brokerage_id_fkey" FOREIGN KEY ("brokerage_id") REFERENCES "brokerage"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
